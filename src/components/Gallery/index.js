    ...
    return (
      <div className="gallery-app">
        <div className="gallery-container">
          <img src={imageUrl} alt={imageAltText} className="image-gallery" />
          <h1 className="gallery-heading">Nature Photography</h1>
          <p className="thumbnail-text">Nature Photography by Rahul</p>
          <ul className="list-container">
            {imagesList.map(eachItem => (
              <ThumbnailItem
                ...
                updateImageGallery={this.updateImageGallery}
              />
            ))}
          </ul>
        </div>
